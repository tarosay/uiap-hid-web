/*
 * Measure_Tn.ino — Flash計測用 BASE + Tn (Tone / PWMmin.h)
 * tone()/noTone() を使わず PWMmin で実装。
...
#define OP_HALT        0x17
// ── Tn: Tone / TONE_FREQ (PWMmin.h) ─────────────────────────
#define OP_TONE_FREQ   0x05  // uint8 pin, uint16 freq (0=stop)
