/*
 * Measure_Rn.ino — Flash計測用 BASE + Rn (RAND/SRAND)
 */
#include <Arduino.h>
#include <WebHID.h>
#include <SDmin.h>
...
#define OP_HALT      0x17
// ── Rn ──
#define OP_RAND      0x21  // uint8 min, uint8 max, uint8 dst_reg → Q16.8 整数
...
static uint32_t xorshift32(void){_rng^=_rng<<13;_rng^=_rng>>17;_rng^=_rng<<5;return _rng;}
